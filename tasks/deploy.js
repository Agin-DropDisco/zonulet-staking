...
task(
    ...
    .setAction(async (taskArguments, hre) => {
        ...
        const ZonuletERC20StakingRewardsDistributionFactory = hre.artifacts.require(
            "ZonuletERC20StakingRewardsDistributionFactory"
        );
        const factory = await ZonuletERC20StakingRewardsDistributionFactory.new(
